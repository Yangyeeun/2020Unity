...
public class IItemDrag : MonoBehaviour
{
    public Transform Img;   // 빈 이미지 객체.
    private IInventory IIv;
    private Image EmptyImg; // 빈 이미지.
    private ISlot slot;      // 현재 슬롯에 스크립트
    ...
    void Start()
    {
        ...
        IIv = GameObject.FindGameObjectWithTag("Inventory").GetComponent<IInventory>();
    }
    ...
    public void DragEnd()
    {
        ...
        IIv.Swap(slot, Img.transform.position);
        //slot = null;
    }
